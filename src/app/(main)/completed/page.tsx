...
const getCompleteTasks = async():Promise<Task[]> => {
...
export default async function MainPage() {
  const completedTasks = await getCompleteTasks();
  return (
    <div className='text-gray-800 p-8 h-full  flex flex-col overflow-y-auto pb-24 bg-gray-100'>
      <header className='flex justify-between items-center my-4'>
        <h1 className='text-2xl font-bold flex items-conter'>Completed Tasks</h1>
